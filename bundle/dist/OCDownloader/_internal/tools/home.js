...
arr_libraries = ["python - 3.13.1", "altgraph - 0.17.4", "bottle - 0.13.2", "certifi - 2025.1.31", "cffi - 1.17.1", "charset-normalizer - 3.4.1", "clr_loader - 0.2.7.post0", "ffmpeg-progress-yield - 0.11.3", "idna - 3.10", "packaging - 24.2", "pefile - 2023.2.7", "pip - 24.3.1", "proxy_tools - 0.1.0", "psutil - 6.1.1", "pycparser - 2.22", "pyinstaller - 6.12.0", "pyinstaller-hooks-contrib - 2025.1", "pythonnet - 3.0.5", "pywebview - 5.4", "pywin32-ctypes - 0.2.3", "requests - 2.32.3", "setuptools - 75.8.0", "typing_extensions - 4.12.2", "urllib3 - 2.3.0", "yt-dlp - 2025.1.26"];
